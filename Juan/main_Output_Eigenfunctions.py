...
for file in files:
    ...
    try:
        ...
        exist_squared = os.path.isfile(f"{saving_file_Potential}/{str(round(energy))}_{str(beta)}.png")
        if exist_squared == False:
            plot_squared_Potential(dominant_mode,dominant_mode_2,alfmode,
                                   ...
                                   energy,beta,frequency,saving_file_Potential,toroidal_coupl, num_poloidal)
